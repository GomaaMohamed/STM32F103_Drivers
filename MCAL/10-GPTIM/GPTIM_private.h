...
******************************************************************************/
#ifndef    _GPTIM_PRIVATE_H
#define    _GPTIM_PRIVATE_H
...
/* GPTIM Registers Mapping data type */
#define  TIM2    ((volatile Gptim_type*)0x40000000)
#define  TIM3    ((volatile Gptim_type*)0x40000400)
#define  TIM4    ((volatile Gptim_type*)0x40000800)
#define  TIM5    ((volatile Gptim_type*)0x40000C00)
...
// Callback variables of timer2
void (*TIM2_CH1_CaptureCompareCallback)(void);
void (*TIM2_CH2_CaptureCompareCallback)(void);
void (*TIM2_CH3_CaptureCompareCallback)(void);
void (*TIM2_CH4_CaptureCompareCallback)(void);
void (*TIM2_OverflowCallback)(void);
void (*TIM2_UnderflowCallback)(void);
static u8 Timer2IntervalModeFlag = 0;
static u16 Timer2Prescaler = 0;

// Callback variables of timer3
void (*TIM3_CH1_CaptureCompareCallback)(void);
void (*TIM3_CH2_CaptureCompareCallback)(void);
void (*TIM3_CH3_CaptureCompareCallback)(void);
void (*TIM3_CH4_CaptureCompareCallback)(void);
void (*TIM3_OverflowCallback)(void);
void (*TIM3_UnderflowCallback)(void);
static u8 Timer3IntervalModeFlag = 0;
static u16 Timer3Prescaler = 0;

// Callback variables of timer4
void (*TIM4_CH1_CaptureCompareCallback)(void);
void (*TIM4_CH2_CaptureCompareCallback)(void);
void (*TIM4_CH3_CaptureCompareCallback)(void);
void (*TIM4_CH4_CaptureCompareCallback)(void);
void (*TIM4_OverflowCallback)(void);
void (*TIM4_UnderflowCallback)(void);
static u8 Timer4IntervalModeFlag = 0;
static u16 Timer4Prescaler = 0;

// Callback variables of timer5
void (*TIM5_CH1_CaptureCompareCallback)(void);
void (*TIM5_CH2_CaptureCompareCallback)(void);
void (*TIM5_CH3_CaptureCompareCallback)(void);
void (*TIM5_CH4_CaptureCompareCallback)(void);
void (*TIM5_OverflowCallback)(void);
void (*TIM5_UnderflowCallback)(void);
static u8 Timer5IntervalModeFlag = 0;
static u16 Timer5Prescaler = 0;
